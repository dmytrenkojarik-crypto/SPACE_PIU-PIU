...
font1 = pygame.font.Font("assets/Starjedi.ttf", 28)
...
class Player(GameSprite):
    ...
    def fire(self):
        ...
        if cur_time_fire - last_time_fire > 0.3:
            bullet = Bullet("assets/bullet.png", self.rect.centerx, self.rect.top, 10, 20, 15)
            bullets.add(bullet)
            fire_sound.play()
...
while game:
    ...
    if not finish and not paused:
        ...
        score_label = font1.render(f"Score: {score}", True, (255, 255, 255))
        missed_label = font1.render(f"Missed: {missed}", True, (255, 255, 255))
